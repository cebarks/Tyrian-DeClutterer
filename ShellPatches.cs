...
namespace Framesaver
{
    ...
    class DontSpawnShellsFiringPatch : ModulePatch
    {
        ...
        {
            return typeof(WeaponManagerClass).GetMethod("method_9", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
        }
    ...
    class DontSpawnShellsJamPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return typeof(WeaponManagerClass).GetMethod("SpawnShellAfterJam", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
        }
    ...
    class DontSpawnShellsAtAllReallyPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return typeof(WeaponManagerClass).GetMethod("method_4", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
        }
